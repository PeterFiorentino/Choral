...
const multer = require('multer');
  ...
  router.post('/', async (req, res) => {
    ...
    try {
      let newCollab = await db.one(`INSERT INTO collaborations(session_id, collaborator_id, audio, instrument_name, approved, volume, stereo_position, is_deleted) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`, [session_id, collaborator_id, audio, instrument_name, approved, volume, stereo_position, false]);
      res.json({
        message: "Success",
        payload: {
          newCollab: newCollab
